...
//#define PLATFORM_BYTE_ORDER BRG_BIG_ENDIAN  // Removed by RWB - one of these must be defined for VC7
...
#define PLATFORM_BYTE_ORDER BRG_LITTLE_ENDIAN	// ADDED BY RWB 
